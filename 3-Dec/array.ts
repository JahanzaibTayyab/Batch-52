...
const guest = ["Arslan", "Asad", "Hassan", "Rimi"];
console.log(guest[0], "Aj roti mri trf sy");
console.log(guest[1], "Aj roti mri trf sy");
console.log(guest[2], "Aj roti mri trf sy");
console.log(guest[3], "Aj roti mri trf sy");

//loops
// condition (true) => Run in that loop logic

// for loops
// while
// do while
// for (let conditionalVariable;condition;updateConditionalVariable)
